...
import { BillTariffMatch } from "@/components/BillTariffMatch";
...
export function BillAnalysisResult({ analysis, onSubmitted }: Props) {
  const cards = [
    ...
    { key: "workPriceCtPerKwh" as const, label: "Arbeitspreis", value: formatValue("workPriceCtPerKwh", analysis.workPriceCtPerKwh.value) ?? "Nicht erkannt", large: true, alwaysVisible: true },
  ...
  return (
    <div className="mt-4 overflow-hidden rounded-[30px] border border-[#1b3b58] bg-[#061a2d] shadow-2xl shadow-black/25">
      ...
      <BillTariffMatch analysis={analysis} />
