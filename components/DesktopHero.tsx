        ...
        <div className="relative z-20">
          ...
          <div className="mt-6 max-w-2xl rounded-2xl border border-white/10 bg-[#06111dcc] p-4 shadow-xl shadow-black/20 backdrop-blur-xl">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 shrink-0 overflow-hidden rounded-full border border-[#19b7ff]/40 bg-[#0b1b30]"><img src="/cristiano.svg" alt="Cristiano Moreira, persönliche Energieberatung" className="h-full w-full object-cover" /></div>
              <div><p className="text-sm font-bold text-white">Persönlich statt Portal</p><p className="mt-0.5 text-sm leading-5 text-slate-400">Ich schaue mir deinen Tarif an. Du bekommst eine klare Einschätzung und entscheidest selbst.</p></div>
            </div>
          </div>
          <HeroAddressCheck />
