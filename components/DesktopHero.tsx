    ...
    <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#020914]" aria-labelledby="hero-heading">
      ...
      <div className="container flex min-h-[720px] items-center py-20">
        <div className="w-full max-w-3xl">
          <h1 id="hero-heading" className="max-w-3xl text-5xl font-black leading-[.95] tracking-[-.055em] text-white md:text-7xl">Zahlst du zu viel für <span className="gradient-text">Strom oder Gas?</span></h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200 md:text-xl">Lade deine letzte Rechnung hoch. Wir analysieren die wichtigsten Tarifdaten und zeigen dir verständlich, wo du stehst.</p>
          <div className="mt-8 max-w-2xl rounded-[1.75rem] border border-white/10 bg-[#06111dcc] p-5 shadow-2xl shadow-black/30 backdrop-blur-xl">
            ...
            <div className="mt-3 rounded-xl border border-emerald-400/10 bg-emerald-400/5 px-3 py-2 text-center text-xs leading-5 text-slate-400">Deine Rechnung wird sicher übertragen und nur zur Tarifprüfung verwendet. <span className="text-slate-300">Mehr dazu in unserer Datenschutzerklärung.</span></div>
          </div>
