  ...
  return <div className="mt-4 rounded-2xl border border-white/10 bg-white/[.035] p-4 text-left">
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        {status === "analyzing" && <p className="mt-2 text-xs text-[#8ce4ff]">Rechnung wird mit mehreren OCR Varianten gelesen. Tarifblöcke werden getrennt und Preise anhand des zugehörigen Abrechnungszeitraums zugeordnet.</p>}
        ...
        {analysis && <div className="mt-4 rounded-xl border border-white/10 bg-black/20 p-3">
          ...
          <p className="mt-1 text-xs leading-5 text-slate-400">Arbeitspreis und Grundpreis werden bei mehreren Tarifen dem zeitlich neuesten Tarifblock zugeordnet. Nicht eindeutig erkannte Werte bleiben leer.</p>
