  ...
  return (
    <section className="mobile-hero relative isolate overflow-hidden border-b border-white/10 bg-[#020914]">
      ...
      <div className="relative mx-auto flex min-h-[980px] w-full max-w-[620px] flex-col px-5 pb-10 pt-10">
        ...
        <div className="mx-auto mt-6 w-full max-w-[520px] rounded-2xl border border-white/10 bg-[#06111dcc] p-3.5 shadow-xl shadow-black/30 backdrop-blur-xl"><div className="flex items-center gap-3"><div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#19b7ff]/40 bg-[#19b7ff]/10 text-xs font-black tracking-tight text-[#8be3ff]">CPM</div><div className="min-w-0"><p className="text-sm font-bold text-white">Persönlich statt Portal</p><p className="mt-0.5 text-xs leading-5 text-slate-400">Ich prüfe deine Rechnung. Du entscheidest selbst.</p></div></div></div>
