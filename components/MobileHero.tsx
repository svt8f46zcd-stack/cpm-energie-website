  ...
  return (
    <section className="mobile-hero relative isolate overflow-hidden border-b border-white/10 bg-[#020914]">
      ...
      <div className="relative mx-auto flex min-h-[980px] w-full max-w-[620px] flex-col px-5 pb-10 pt-10">
        ...
        <div className="mx-auto mt-6 w-full max-w-[520px] rounded-2xl border border-white/10 bg-[#06111dcc] p-3.5 shadow-xl shadow-black/30 backdrop-blur-xl"><div className="flex items-center gap-3"><div className="h-11 w-11 shrink-0 overflow-hidden rounded-full border border-[#19b7ff]/40 bg-[#0b1b30]"><img src="/cristiano.svg" alt="Cristiano Moreira" className="h-full w-full object-cover" /></div><div className="min-w-0"><p className="text-sm font-bold text-white">Persönlich statt Portal</p><p className="mt-0.5 text-xs leading-5 text-slate-400">Ich prüfe deine Rechnung. Du entscheidest selbst.</p></div></div></div>
        <div className="relative mx-auto mt-5 w-full max-w-[520px]"><div className="absolute -inset-4 rounded-[2rem] bg-[#19b7ff]/10 blur-2xl motion-safe:animate-[mobileEnergyGlow_4s_ease-in-out_infinite]" /><div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-[#06111dcc] p-4 shadow-2xl shadow-black/40 backdrop-blur-xl"><div className="mb-4 flex items-center justify-between"><div><p className="text-sm font-bold text-white">Tarif kostenlos prüfen</p><p className="mt-0.5 text-xs text-slate-400">Rechnung hochladen oder Verbrauch eingeben</p></div><div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-[#19b7ff]/40 bg-[#19b7ff]/10"><span className="absolute h-2.5 w-2.5 rounded-full bg-[#75dcff] shadow-[0_0_18px_5px_rgba(25,183,255,.65)] motion-safe:animate-[energyPulse_2.4s_ease-in-out_infinite]" /><span className="h-7 w-7 rounded-full border border-[#75dcff]/35" /></div></div><HeroAddressCheck /><BillUpload onContinue={() => { window.location.href = "/kontakt/rechnung"; }} /></div></div>
